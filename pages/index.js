  ...
  <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px", position: "relative", zIndex: 10, opacity: anim ? 1 : 0, transform: anim ? "translateY(0)" : "translateY(14px)", transition: "all 0.26s ease" }}>
    ...
    {step === "result" && concept && !karakterStep && (
      <div style={{ width: "100%", maxWidth: 560 }} key={rk}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[{ label: "Karakter", val: concept.karakter }, { label: "Açılış Sahnesi", val: concept.sahne }].map(({ label, val }) => (
              <div key={label} style={{ ...glass, borderRadius: 16, padding: "14px 16px", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "Courier New, monospace", color: "rgba(255,255,255,0.4)", marginBottom: 6 }}>{label}</p>
                <p style={{ fontSize: 12, lineHeight: 1.6, color: "rgba(255,255,255,0.85)", fontFamily: "Courier New, monospace" }}>{val}</p>
              </div>
            ))}
          </div>
          <div style={{ ...glass, borderRadius: 16, padding: "16px", textAlign: "center", borderColor: `${accent}30`, background: `${accent}0e`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 20, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button onClick={() => go(() => setStep("tur"))} style={{ ...glass, padding: "8px 16px", borderRadius: 12, fontSize: 12, fontWeight: 700, cursor: "pointer", color: "rgba(255,255,255,0.85)" }}>🎭 Tür</button>
    ...
    {step === "result" && karakterStep && karakter && (
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.5)", fontFamily: "Courier New, monospace", marginBottom: 24 }}>{concept.baslik} · {concept.karakter?.split("—")[0]}</p>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            <div key={label} style={{ ...glass, borderRadius: 16, padding: "16px 18px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "Courier New, monospace", color, marginBottom: 8 }}>{label}</p>
              <p style={{ fontSize: 13, lineHeight: 1.65, color: "rgba(255,255,255,0.88)" }}>{val}</p>
            </div>
          ))}
        </div>
        <div style={{ display: "flex", gap: 8, marginTop: 20, justifyContent: "center" }}>
          <button onClick={() => setKarakterStep(false)} style={{ ...glass, padding: "8px 18px", borderRadius: 12, fontSize: 12, fontWeight: 700, cursor: "pointer", color: "rgba(255,255,255,0.8)" }}>← Konuya Dön</button>
