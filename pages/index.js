    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "-apple-system,BlinkMacSystemFont,sans-serif", opacity: loaded ? 1 : 0, transition: "opacity 0.3s" }}>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(min-width:769px){.mtb{display:none!important;}.mbn{display:none!important;}.fab{display:none!important;}} @media(max-width:768px){.mbn{display:flex!important;}}
      `}</style>
      ...
      {/* MOBİL ALT NAV */}
      <div className="mbn" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 100, background: dk ? "rgba(8,15,28,0.96)" : "rgba(255,255,255,0.96)", backdropFilter: "blur(28px)", borderTop: "1px solid " + C.border, padding: "10px 0 env(safe-area-inset-bottom,10px)", display: "flex", justifyContent: "space-around", alignItems: "center" }}>
