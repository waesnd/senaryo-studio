...
export default function KullaniciProfil() {
  ...
  if (yukleniyor) return <div style={{ minHeight: "100vh", background: dk ? "#080f1c" : "#f4f6fb", display: "flex", alignItems: "center", justifyContent: "center" }}><div style={{ width: 28, height: 28, border: "3px solid rgba(8,145,178,0.2)", borderTopColor: TEAL, borderRadius: "50%", animation: "spin 0.8s linear infinite" }} /><style>{`@keyframes spin{to{transform:rotate(360deg);}}`}</style></div>;
  if (!profil) return <div style={{ minHeight: "100vh", background: dk ? "#080f1c" : "#f4f6fb", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "-apple-system,sans-serif", flexDirection: "column", gap: 16 }}><p style={{ fontSize: 48 }}>😕</p><p style={{ color: dk ? "#f1f5f9" : "#0f172a" }}>Kullanıcı bulunamadı</p><a href="/" style={{ color: TEAL, fontWeight: 700 }}>← Ana Sayfaya Dön</a></div>;
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{ padding: "0 20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
            <h1 style={{ fontSize: 20, fontWeight: 800, color: C.text }}>@{profil.username}</h1>
            {profil?.dogrulandi && (
