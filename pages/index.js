...
export default function App() {
  ...
  var musicOn = false; var setMusicOn = function() {};
    ...
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "Georgia, serif", fontWeight: 700, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "52px 20px 0" }}>
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <button onClick={function() { window.location.href = "/kesfet"; }} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 16, padding: "5px 11px", color: "rgba(255,255,255,0.55)", fontSize: 10, fontWeight: 900, cursor: "pointer", fontFamily: "Courier New, monospace", letterSpacing: "0.08em" }}>KEŞFEt</button>
          <button onClick={function() { window.location.href = "/topluluk"; }} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 16, padding: "5px 11px", color: "rgba(255,255,255,0.55)", fontSize: 10, fontWeight: 900, cursor: "pointer", fontFamily: "Courier New, monospace", letterSpacing: "0.08em" }}>TOPLULUK</button>
          <button onClick={function() { window.location.href = "/profil"; }} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 16, padding: "5px 11px", color: "rgba(255,255,255,0.55)", fontSize: 10, fontWeight: 900, cursor: "pointer", fontFamily: "Courier New, monospace", letterSpacing: "0.08em" }}>PROFİL</button>
          <button onClick={function() { user ? cikis() : setAuthPanel(true); }} style={{ background: user ? "rgba(74,222,128,0.1)" : "rgba(232,35,10,0.12)", border: "1px solid " + (user ? "rgba(74,222,128,0.25)" : "rgba(232,35,10,0.25)"), borderRadius: 16, padding: "5px 12px", color: user ? "#4ade80" : "#e8230a", fontSize: 10, fontWeight: 900, cursor: "pointer", fontFamily: "Courier New, monospace", letterSpacing: "0.08em" }}>
            {user ? "✓ ÇIKIŞ" : "GİRİŞ"}
          </button>
        </div>
      </div>
