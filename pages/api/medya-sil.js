...
export default async function handler(req, res) {
  ...
  var cloud_name = process.env.CLOUDINARY_CLOUD_NAME || "duuebxmro";
  var api_key = process.env.CLOUDINARY_API_KEY || "926939593417442";
  var api_secret = process.env.CLOUDINARY_API_SECRET || "uoCYzf2539IPGH3-VtwWOIlrMNQ";
