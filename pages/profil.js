...
export default function Profil() {
  ...
  async function yukle(u) {
    ...
    if (p) {
      ...
      // Sadece username hiç set edilmemişse aç
  ...
  async function profilKaydet() {
    ...
    if (error) { alert("Kayıt hatası: " + error.message); setKaydetYukleniyor(false); return; }
