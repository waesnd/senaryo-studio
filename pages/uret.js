          ...
          <div style={{ position: "fixed", top: 0, left: 0, bottom: 0, zIndex: 201, width: 300, background: dk ? "#0d1627" : "#fff", boxShadow: "4px 0 40px rgba(0,0,0,0.25)", display: "flex", flexDirection: "column", animation: "slideIn 0.28s cubic-bezier(0.34,1.2,0.64,1)" }}>
            ...
            <nav style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
              ...
              <div style={{ marginTop:16, paddingTop:16, borderTop:"1px solid "+C.border }}>
                ...
                <a href="/profil" onClick={function(){setDrawer(false);}} style={{ display:"flex", alignItems:"center", gap:14, padding:"12px 14px", borderRadius:14, color:C.text, fontSize:15, marginBottom:4, textDecoration:"none", background: "/profil"==="/uret" ? TEAL+"10" : "transparent", fontWeight: "/profil"==="/uret" ? 700 : 500 }}>
